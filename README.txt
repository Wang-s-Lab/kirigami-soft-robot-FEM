...
3) The smaple program demonstrates the deformation of a single-module kirigami soft robot with Y-axis symmetric magnetization pattern 
 and applied Y-axis magnetic field with a  magnitude of 15 mT.
